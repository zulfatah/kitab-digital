      ...
      <div className={preferences.theme === 'dark' ? 'dark' : ''}>
        ...
        <header id="main-header" className="sticky top-0 z-40 bg-[#FDFBF7]/90 dark:bg-[#121210]/90 backdrop-blur-md border-b border-[#E5E1D8] dark:border-[#3A3A30] transition-all">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex items-center justify-between gap-3">
            {/* Logo / Brand */}
            <div id="brand-container" className="flex items-center gap-2.5 cursor-pointer group" onClick={() => setView('library')}>
              <KitabLogo 
                className="w-10 h-10 flex-shrink-0 transition-transform duration-300 group-hover:scale-105 active:scale-95 shadow-sm" 
                variant={preferences.theme === 'dark' ? 'dark' : 'colored'} 
              />
              <div>
                <h1 className="font-serif font-bold text-[#5A5A40] dark:text-[#E5E1D8] text-base sm:text-lg tracking-tight leading-none group-hover:text-amber-600 dark:group-hover:text-amber-400 transition-colors">
                  Kitab Digital
                </h1>
                <p className="text-[9px] sm:text-[10px] text-[#999488] font-medium mt-0.5 uppercase tracking-wider">
                  Pustaka & Catatan Minimalis
                </p>
              </div>
            </div>
            ...
            <nav id="main-nav-tabs" className="hidden md:flex items-center gap-1.5">
              {[
                ...
                ...(currentUserEmail ? [
                  { id: 'writer', label: 'Tulis Kitab', icon: Plus },
        ...
        <main id="main-content-stage" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 sm:py-8 pb-24 sm:pb-8">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-4 gap-6 items-start">
            ...
            <div className={view === 'reader' ? "xl:col-span-4" : "xl:col-span-3"}>
            ...
            {/* Right sidebar - only show when not in reader mode */}
            {view !== 'reader' && (
